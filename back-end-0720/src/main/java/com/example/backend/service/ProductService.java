...
public class ProductService {
    ...
    public int store(String title, String model, String description, long price, String category,
                     int discount, int percent, String saleYn, MultipartFile file) throws IOException {
        String fileName = StringUtils.cleanPath(file.getOriginalFilename());

        Product Product = new Product(fileName, title, model, description,price, category,
                discount, percent, saleYn, file.getContentType(), file.getBytes());
